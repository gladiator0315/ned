...
declare function setidentity(identity: number?): (number, number)
-- you can uncomment these functions or add functions yourself it's useful

declare function getgenv(): genv
declare function cachereplace(Instance: Instance?): Instance
declare function firesignal(signal: any?): any
declare function lockModule(ModuleScript: Instance?): Instance
declare function isscriptable(property: Instance?): Instance
declare function setrconsoletitle(title: string?): string
declare function hookmetamethod(metamethod: any?): any
declare function isownthread(thread: any?): any
declare function getexecutorname(): any
declare function getrawmetatable(metatable: any?): any
declare function createfolder(name: string?): any
declare function getcallingscript(): any
declare function getallthreads(): any
declare function mouse1press(): any
declare function toclipboard(text: string?): string
declare function newcclosure(): any
declare function request(http: any?): any
declare function cloneinstance(Instance: Instance?): any
declare function setscriptable(): any
declare function mousescroll(): any
declare function unlockmodule(Module: Instance?): any
declare function mouse2release(): any
declare function folderexist(name: string?): any
declare function isrbxactive(): boolean
declare function rconsoleinfo(text: string?): any
declare function deletefile(name: string?): any
declare function rconsolename(text: string?): any
declare function getupvalue(upvalue: any?): any
declare function replaceinstancecache(cache: Instance?): Instance
declare function disableconnection(connection: any?): any
declare function setproto(): any
declare function mouse1click(): any
declare function setupvalue(upvalue: any?): any
declare function isfolder(name: string?): string
declare function enablesignal(signal: any?): any
declare function gethiddenproperty(property: any?): any
declare function identifyexecutor(): any
declare function fireconnection(connection: any?): any
declare function makereadonly(property: any?): any
declare function rconsoleerr(text: string?): string
declare function filexist(name: string?): string
declare function setfps(number: number?): number
declare function iscclosure(cclosure: any?): any
declare function keypress(): any
declare function getinstancelist(): any
declare function fireproximityprompt(proximityprompt: any?): any
declare function getupvalues(): any
declare function get_hidden_gui(): any
declare function rconsoleclear(): any
declare function isexecutorclosure(executor: any?): any
declare function rconsoleprint(text: string?): string
declare function makewriteable(property: Instance?): Instance
declare function randomstring(): any
declare function getnilinstances(): any
declare function setclipboard(text: string?): string
declare function isreadonly(property: Instance?): Instance
declare function mouse2click(): any
declare function sethiddenproperty(): any
declare function writefile(text: string?): string
declare function isfocused(): any
declare function getconstant(constant: any?): any
declare function setpropertyable(property: any?): any
declare function getnamecallmethod(namecall: any?): any
declare function getsenv(senv: any?): any
declare function unlockfps(framerate: number?): number
declare function HttpPost(link: any?): any
declare function HttpPostAsync(link: any?): any
declare function getconnections(connection: any?): any
declare function checkcaller(call: any?): any
declare function getasset(asset: any?): any
declare function rconsoledestroy(): any
declare function setreadonly(property: any?): any
declare function getscriptfromthread(thread: any?): any
declare function setconstant(constant: any?): any
declare function httprequest(link: any?): any
declare function saveinstance(): any
declare function rconsolewarn(text: string?): string
declare function queueteleportscript(script: any?): any
declare function getregistry(): any
declare function compareinstances(Instance: any?): Instance
declare function hookfunction(func: any?): any
declare function mouse1release(): any
declare function setnamecallmethod(namecall: any?): any
declare function fpsunlock(): any
declare function setfpscap(framerate: number?): any
declare function getfflags(): any
declare function getflags(): any
declare function setflag(flag: any?): any
declare function setfflag(): any
declare function erasedraw(): any
declare function getcustomasset(asset: any?): any
declare function replaceclosure(closure: any?): any
declare function addqueuescript(): any
declare function queue_on_teleport(script: any?): any
declare function getcontext(context: any?): any
declare function isfile(file: any?): any
declare function listfiles(): any
declare function readfile(file: any?): any
declare function appendfile(file: any?): any
declare function firetouchinterest(touchInterest: any?): any
declare function require(module: any?): any
declare function cloneref(reference: any?): any
declare function iscache(file: any?): any
declare function mousemoverel(): any
declare function setfpslimit(framerate: number?): any
declare function replacecclosure(cclosure: any?): any
declare function clonefunction(func: any?): any
declare function mouse2press(): any
declare function setrawmetatable(metatable: any?): any
declare function cacheinvalidate(cache: any?): any
declare function loadcustomasset(link: any?): any
declare function getproto(proto: any?): any
declare function invalidatecache(cache: any?): any
declare function getprotos(): any
declare function checkclosure(closure: any?): any
declare function getgc(): any
declare function getidentity(): any
declare function getrenv(): any
declare function GetObjects(): any
declare function fireclickdetector(clickdetector: any?): any
declare function rconsoleinput(): any
declare function getmenv(): any
declare function getreg(): any
declare function mousemoveabs(position: number?): number
declare function keypress(key: any?): any
declare function keyrelease(key: any): any
